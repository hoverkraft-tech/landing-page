...
describe('BlogPostGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate complete blog post', async () => {
      ...
      const frenchMdxCall = mockFileSystemService.writeFile.mock.calls.find((call) =>
        call.arguments?.[0].endsWith('fr.mdx')
      );
  ...
  describe('generateSlug', () => {
    it('should generate correct slug with hash', () => {
      const result = blogPostGenerator.generateSlug('2025-11-15T00:00:00Z', '2025-11-15T23:59:59Z');
    ...
    it('should generate different slugs for different date ranges', () => {
      const result1 = blogPostGenerator.generateSlug('2025-11-15T00:00:00Z', '2025-11-15T23:59:59Z');
      const result2 = blogPostGenerator.generateSlug('2025-11-08T00:00:00Z', '2025-11-15T23:59:59Z');
  ...
  describe('generateCommonYaml', () => {
    it('should generate valid YAML content', () => {
      const result = blogPostGenerator.generateCommonYaml('releases-2025-11-15-abc123de');

      assert.ok(result.includes('publishDate:'));
      assert.ok(result.includes('image: ~/assets/images/blog/releases-2025-11-15-abc123de/preview.png'));
      ...
      assert.ok(result.includes('translationKey: releases-2025-11-15-abc123de'));
    });
  });
});
