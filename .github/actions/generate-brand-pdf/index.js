...
async function run() {
  ...
  try {
    const pageUrl = core.getInput('page-url') || 'http://localhost:4321/charte-graphique';
    const outputFile = core.getInput('output-file') || 'application/public/brand/downloads/hoverkraft-brand-guidelines.pdf';
    const workingDirectory = core.getInput('working-directory') || 'application';
